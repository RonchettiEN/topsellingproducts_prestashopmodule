...
<div class="panel">
    <div class="error-title">
        <div class="error-action">
            <form method="post" action={$action} id="form_all">
                <input type="hidden" name="submitDeleteErrorProductsOnSaleModule" value="0" />
                <button type="submit" class="btn btn-danger" form="form_all">{l s='Delete all' mod='productsonsale'}</button>
            </form>
        </div>
        <h3><i class="icon icon-warning-sign"></i> {l s='Errors' mod='productsonsale'}</h3>
    </div>
